    ...
    <div className="flex flex-col gap-5 sm:gap-6 animate-slide-up">
      ...
      <div className="bg-black text-white rounded-xl sm:rounded-2xl p-5 sm:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6 border border-zinc-800">
        <div className="flex items-start gap-3.5">
          ...
          <div>
            ...
            <p className="font-body text-xs text-zinc-300 mt-1 max-w-2xl leading-relaxed">
              Analyzes your uploaded CSV column headers and data to structure entity nodes, primary key identifiers, properties, and relationship links.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <span>{isGeneratingSchema ? 'Analyzing CSV...' : 'Auto-Structure Graph Schema'}</span>
        </button>
      </div>
                    ...
                    {headers.map(h => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 py-0.5 rounded text-[10px] font-mono font-medium transition-all flex items-center gap-1 ${
                            isChecked
